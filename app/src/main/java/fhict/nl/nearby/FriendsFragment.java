        ...
        user_db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot dataSnapshotUser : dataSnapshot.getChildren()){
                    Object nickname = dataSnapshotUser.child("nickname").getValue();
                    if(nickname == null){
                        continue;
                    }
                    
                    map.put(dataSnapshotUser.getKey(), nickname.toString());
                    map.put(nickname.toString(), dataSnapshotUser.getKey());
